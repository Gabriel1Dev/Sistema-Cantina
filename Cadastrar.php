<?php
    include("conexao.php");
        if(isset($_POST['usuario']) || isset($_POST['contato']) || isset($_POST['cpf']))
        {
            if(strlen($_POST['usuario']) == 0){
                echo '<script>alert("Preencha o campo com seu login");</script>';
            }
            else if(strlen($_POST['contato']) == 0){
                echo '<script>alert("Preencha o campo com seu contato");</script>';
            }
            ...
            else
            {
                ...
                {
                    echo '<script>alert("Esse login ja esta cadastrado!");</script>';
                }
            }
        }
    ?>
...
<body class="bg-dark">
    <form action="Cadastrar.php" method="post">
        <div id="formulario">
            ...
            <input type="password" name="cpf" id="cpf" placeholder="cpf" required>
            <br>
